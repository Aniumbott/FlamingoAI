import { addArticleJsonLd } from '@/hashnode/starter-kit/utils/seo/addArticleJsonLd';
import { getAutogeneratedPostOG } from '@/hashnode/starter-kit/utils/social/og';
...
import { PostTOC } from '../../hashnode/components/post-toc';
...
import handleMathJax from '@/hashnode/starter-kit/utils/handle-math-jax';
import { useEmbeds } from '@/hashnode/starter-kit/utils/renderer/hooks/useEmbeds';
import { loadIframeResizer } from '@/hashnode/starter-kit/utils/renderer/services/embed';
import { useEffect, useState } from 'react';
import { triggerCustomWidgetEmbed } from '@/hashnode/starter-kit/utils/trigger-custom-widget-embed';

const AboutAuthor = dynamic(() => import('@/hashnode/components/about-author'), { ssr: false });
const Subscribe = dynamic(() => import('@/hashnode/components/subscribe').then((mod) => mod.Subscribe));
const PostComments = dynamic(() =>
	import('@/hashnode/components/post-comments').then((mod) => mod.PostComments),
);
